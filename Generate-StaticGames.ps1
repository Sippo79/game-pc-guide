...
$($buildCards -join "`r`n")
        ...
        <section class="affiliate-section" aria-labelledby="affiliateTitle">
          ...
          <div class="affiliate-link-grid">
            <a class="affiliate-button affiliate-button-bto" href="https://example.com/bto" target="_blank" rel="nofollow sponsored noopener noreferrer">
              <span>このゲーム向けBTOパソコンを探す</span>
              <small>推奨スペックに近い完成品PCをチェック</small>
            </a>
            <a class="affiliate-button affiliate-button-amazonParts" href="https://example.com/amazon-parts" target="_blank" rel="nofollow sponsored noopener noreferrer">
              <span>AmazonでPCパーツを見る</span>
              <small>CPU・GPU・メモリなどをまとめて探す</small>
            </a>
            <a class="affiliate-button affiliate-button-rakutenParts" href="https://example.com/rakuten-parts" target="_blank" rel="nofollow sponsored noopener noreferrer">
              <span>楽天でPCパーツを見る</span>
              <small>ポイント還元も見ながらパーツを比較</small>
            </a>
            <a class="affiliate-button affiliate-button-monitor" href="https://example.com/monitor" target="_blank" rel="nofollow sponsored noopener noreferrer">
              <span>ゲーミングモニターを見る</span>
              <small>144Hz以上やWQHD環境を整えたい人向け</small>
            </a>
            <a class="affiliate-button affiliate-button-mouse" href="https://example.com/mouse" target="_blank" rel="nofollow sponsored noopener noreferrer">
              <span>ゲーミングマウスを見る</span>
              <small>FPSや長時間プレイの操作感を改善</small>
            </a>
          </div>
